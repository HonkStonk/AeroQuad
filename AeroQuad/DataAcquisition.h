...
void updateControls() {
  ...
  for(j=0;j<2;j++) {
    ...
    void initCHR6DM(){
        ...
        chr6dm.setActiveChannels(CHANNEL_YAW_MASK | CHANNEL_PITCH_MASK | CHANNEL_ROLL_MASK | CHANNEL_YAW_RATE_MASK | CHANNEL_PITCH_RATE_MASK | CHANNEL_ROLL_RATE_MASK | CHANNEL_AY_MASK | CHANNEL_AX_MASK | CHANNEL_AZ_MASK); //CHANNEL_YAW_MASK CHANNEL_PITCH_MASK CHANNEL_ROLL_MASK CHANNEL_YAW_RATE_MASK CHANNEL_PITCH_RATE_MASK CHANNEL_ROLL_RATE_MASK CHANNEL_AY_MASK CHANNEL_AX_MASK CHANNEL_AZ_MASK //CHANNEL_ALL_MASK
