...
/*****************************************************************************************/
//           USING OLD MIGHT NOT WORK BUT THEN JUST USE ABOVE SINCE CONFIRMED            //
/****************************************************************************************/
...
public: 
  ...
  void measure(void) {
    ...
    rawAltitude = (44330 * (1 - pow(pressure/101325.0, pressureFactor)))+80; // returns absolute altitude in meters //HONK
    altitude = smooth(rawAltitude, altitude, smoothFactor); // smoothFactor defined in main class
