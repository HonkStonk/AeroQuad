...
class MPX_Barometer_Oilpan : public Altitude {
private:
  uint8_t MPX_ADC_ch;
  uint16_t rawADC;
...
public: 
  ...
  void measure(void) {
    rawADC = analogRead_ArduCopter_ADC(MPX_ADC_ch);
      
      if(rawADC<50 || rawADC>4050) { digitalWrite(LED_Green, LOW); }
