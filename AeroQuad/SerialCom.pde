...
void readSerialCommand() {
  ...
  if (Serial.available()) {
    ...
    case 'b': // calibrate gyros
      gyro.calibrate();
      //#ifdef AltitudeHold
      //altitude.initialize(); // calibrate altitude to read 0 at ground level
      //#endif
      break;
...
void sendSerialTelemetry() {
  ...
  case '=': // Reserved debug command to view any variable from Serial Monitor
    ...
    */
    PrintValueComma(analogRead_ArduCopter_ADC(0));
    PrintValueComma(analogRead_ArduCopter_ADC(1));
    PrintValueComma(analogRead_ArduCopter_ADC(2));
    PrintValueComma(analogRead_ArduCopter_ADC(3));
    PrintValueComma(analogRead_ArduCopter_ADC(4));
    PrintValueComma(analogRead_ArduCopter_ADC(5));
    PrintValueComma(analogRead_ArduCopter_ADC(6));
    PrintValueComma(analogRead_ArduCopter_ADC(7));
    //Serial.print(altitude.getData());
    Serial.println(" ");
    //printFreeMemory();
    //queryType = 'X';
